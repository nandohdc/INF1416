...
public class MyMessageDigest {
    ...
    protected MyMessageDigest(String NewAlgorithm){
        this.setAlgorithm(NewAlgorithm);
    }

    protected void selectMessageDigest() throws NoSuchAlgorithmException {
    ...
    protected byte[] generateMessageDigest(byte[] NewMessage) throws NoSuchAlgorithmException {
        this.setMessage(NewMessage);
        this.selectMessageDigest();
        this.getMessageDigest().update(this.getMessage());
