...
public class MySignature {
    ...
    public MySignature(byte[] NewMessage, String NewAlgorithm){
        this.myMessageDigest =  new MyMessageDigest(NewMessage, NewAlgorithm);
    }
    ...
    public void update() throws NoSuchAlgorithmException {
        ...
        this.myMessageDigest.generateMessageDigest();
    }
